        ...
        if _ACCOUNT_TYPE_TO_CALCULATION.get(a.get("type")) == "credit_card":
            ...
            if a.get("balance") is not None:
                ...
                row = [
                    ...
                    fmt_money(limit) if limit is not None else "-",
                    fmt_money(available) if available is not None else "-",
            ...
            elif limit is not None and available is not None:
