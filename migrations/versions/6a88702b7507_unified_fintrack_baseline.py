...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "available_balance", sa.Numeric(precision=12, scale=2), nullable=True
        ),
        sa.Column("available_balance_date", sa.Date(), nullable=True),
        sa.Column(
            "beginning_balance", sa.Numeric(precision=12, scale=2), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "account_id", "as_of", "source", name="uq_balance_history_point"
        ),
    )
    op.create_table(
        "transactions",
    ...
    op.create_index(
        "ix_transactions_fingerprint", "transactions", ["fingerprint"], unique=False
    )
    op.create_table(
